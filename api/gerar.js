...
Regras de INTERAÇÃO (Obrigatório para os botões funcionarem):
...
- Se criar um menu hambúrguer para celular, adicione o código JavaScript necessário inline ou em uma tag <script> interna para fazer o menu abrir e fechar de verdade ao clicar.
